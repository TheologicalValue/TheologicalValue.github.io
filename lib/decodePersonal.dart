                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        ...
                        rootBundle.loadString("aaa/questions.json").then((jsonString) {
                          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => DecodeTest(ids: id.list, jsonString: jsonString)));
                        });
                      },
                      child: const Text(
                        "시작하기",
                      ...
                      style: ElevatedButton.styleFrom(
                          primary: Colors.blueAccent, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)), elevation: 10.0)),
                  minWidth: 100,
                  height: 50,
                )
              ],
...
class DecodeTest extends StatefulWidget {
  const DecodeTest({Key? key, required this.ids, required this.jsonString}) : super(key: key);
...
class _DecodeTestState extends State<DecodeTest> {
  ...
  List<PersonalIdWidget> personalIdWidgets = [const PersonalIdWidget(number: 0, output: "LOADING...", pid: "PP00")];
